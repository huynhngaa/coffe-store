                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <span class="text-secondary"><?php echo $row2['tong'] ?></span>
                                </li>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input name="name" type="text" class="form-control" value="<?php echo $row['ten'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input name="sdt" type="text" class="form-control" value="<?php echo $row['so_dien_thoai'] ?>">
                                    </div>
                                </div>
                                <!-- <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input name="pass" type="text" class="form-control" value="<?php echo $row['mat_khau'] ?>">
                                    </div>
                                </div> -->
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input name="dc" type="text" class="form-control" value="<?php echo $row['dia_chi'] ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
