                    ...
                    <table class="table table-hover">
                      ...
                      <?php
                        ...
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="../img/<?php echo $row['hinh_anh']?>" alt="image" />
                          </td>
                          <td><?php echo $row['ten']?></td>
                          <td>
    <span class="text-danger font-weight-bold"><?php echo number_format($row['gia']) ?> đ</span>
</td>

                          <td><label class="badge badge-warning"><?php echo $row['tenloai']?></label></td>
                          <td class="col-4" style="white-space: normal;"><?php echo $row['mota']?></td>
